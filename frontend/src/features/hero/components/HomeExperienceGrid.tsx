        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.25rem] bg-white p-2 shadow-[0_28px_72px_rgba(0,0,0,0.12)] ring-1 ring-slate-200/60 md:rounded-[3rem] md:p-4">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            {EXPERIENCES.map((item) => (
              ...
              >
                <div
                  className={`relative flex h-[4.25rem] w-[4.25rem] shrink-0 items-center justify-center rounded-[1.2rem] ring-1 transition-all duration-500 group-hover:-translate-y-1 group-hover:scale-[1.06] md:h-[4.9rem] md:w-[4.9rem] ${item.bg} group-hover:shadow-[0_20px_36px_rgba(15,76,129,0.12)]`}
                >
                  <CategoryBrandIcon
