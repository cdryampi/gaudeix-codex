...
import { Newspaper, RadioTower, RefreshCw, TriangleAlert } from "lucide-react";
...
export function NewsPage() {
  ...
  const hasNoPublishedNews = !loading && !error && newsItems.length === 0;
  const hasNoFilteredResults =
    !loading && !error && newsItems.length > 0 && filteredNews.length === 0;
        ...
        {loading ? (
          ...
          <div className="card-surface flex flex-col items-center justify-center gap-5 py-20 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-xl text-sm leading-relaxed text-slate-500">
                Comprueba tu conexion o vuelve a intentarlo en unos segundos.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="card-surface flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="mt-3 max-w-lg text-sm leading-relaxed text-slate-500">
              Cuando el ayuntamiento publique nuevas noticias apareceran aqui.
            </p>
          </div>
