...
- Describe las tareas a Jules usando prompts completos, citando el material relevante de `/docs`.
...
- Evalúa las propuestas y diffs generados por Jules o subagentes.
