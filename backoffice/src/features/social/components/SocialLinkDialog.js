...
export function SocialLinkDialog({ open, onOpenChange, onSubmit, link }) {
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      className: "max-w-[640px] px-6",
      children: [
        _jsx(DialogHeader, {
          children: _jsx(DialogTitle, {
            children: link ? "Editar enlace" : "Nuevo enlace",
          }),
        }),
        _jsxs("form", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  className: "space-y-2",
                  children: [
                    _jsx(Label, { htmlFor: "order", children: "Orden" }),
                    _jsx("div", {
                      className: "w-full",
                      children: _jsx(Input, {
                        id: "order",
            ...
            _jsxs("div", {
              className: "space-y-2",
              children: [
                _jsx(Label, { htmlFor: "url", children: "URL" }),
                _jsx("div", {
                  className: "w-full",
                  children: _jsx(Input, {
                    id: "url",
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("datalist", {
                      id: "icon-suggestions",
                      children: iconSuggestions.map((item) =>
                        _jsx("option", { value: item }, item),
                      ),
                    }),
                    _jsx("p", {
            ...
            _jsx("div", {
              ...
              children: _jsx(Button, {
                type: "submit",
                children: link ? "Guardar cambios" : "Crear enlace",
              }),
            }),
          ],
        }),
...
function ToggleRow({ label, checked, onCheckedChange }) {
  return _jsxs("label", {
    ...
    children: [
      ...
      _jsx(Switch, { checked: checked, onCheckedChange: onCheckedChange }),
    ],
  });
}
