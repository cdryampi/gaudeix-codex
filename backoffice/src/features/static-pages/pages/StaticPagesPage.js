  ...
  return _jsxs(PageContainer, {
    children: [
      _jsx(PageHeader, {
        ...
        description:
          "Gestiona plantillas predefinidas (info point, privacidad, legal, cookies, contacto, inclusi\u00F3).",
        actions: _jsx("div", {
      ...
      _jsxs("div", {
        ...
        children: [
                ...
                children: [
                  ...
                  _jsxs("select", {
                    ...
                    children: [
                      _jsx("option", {
                        value: "",
                        children: "Publicaci\u00F3n (todas)",
                      }),
                      _jsx("option", { value: "true", children: "Publicadas" }),
                      _jsx("option", {
                        value: "false",
                        children: "Borradores",
                      }),
          ...
          _jsxs(Badge, {
            ...
            children: [filtered.length, " p\u00E1ginas"],
          }),
        ],
      }),
      _jsxs(Alert, {
        ...
        children: [
          ...
          _jsx(AlertTitle, {
            children: "Men\u00FAs y est\u00E1ticas son sensibles",
          }),
          _jsx(AlertDescription, {
            className: "text-sm",
            children:
              "Cada plantilla es \u00FAnica y se muestra en la web p\u00FAblica. Evita cambios innecesarios en slugs, plantillas o documentos legales. Para crear nuevas p\u00E1ginas usa solo las plantillas predefinidas y revisa enlaces en el header/footer.",
          }),
        ],
      }),
      _jsx(Card, {
