...
export function PlaceDialog({ open, onOpenChange, onSubmit, place }: Props) {
  ...
  const getLatLng = useCallback((payload: PlacePayload) => {
  ...
  }, [open, form, getLatLng, updateCoordinates, reverseGeocode]);
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, booking_url: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-3 rounded-lg border border-border/60 bg-muted/30 p-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Documentos vinculados al lugar
                </p>
              </div>
              <div className="flex gap-2">
                <input
