...
export const categoriesApi = {
    ...
    async create(payload) {
        const response = await apiClient.post(API_ENDPOINTS.CATEGORIES.LIST, payload);
        return normalizeCategory(response.data);
    },
    async update(id, payload) {
        const response = await apiClient.patch(API_ENDPOINTS.CATEGORIES.DETAIL(String(id)), payload);
        return normalizeCategory(response.data);
    },
    async remove(id) {
