        ...
        children: [
          _jsx("thead", {
            ...
            children: _jsxs("tr", {
              ...
              children: [
                _jsx("th", { children: "Usuario" }),
                _jsx("th", { children: "Email" }),
                _jsx("th", { children: "Rol" }),
                        ...
                        children: [
                          _jsx("td", {
                            ...
                            children: _jsxs("div", {
                              ...
                              children: [
                                _jsx(Avatar, {
                                  className:
                                    "h-10 w-10 border border-border bg-muted",
                          ...
                          _jsx("td", {
                            ...
                            children: user.is_staff
                              ? _jsxs(Badge, {
                                  className:
                                    "gap-1 bg-purple-50 text-purple-700 hover:bg-purple-50 dark:bg-purple-900/30 dark:text-purple-200",
                                  children: [
                                    _jsx(ShieldCheck, {
                              ...
                              : _jsxs(Badge, {
                                  variant: "secondary",
                                  className:
                                    "gap-1 text-slate-700 dark:bg-slate-800 dark:text-slate-100",
                                  children: [
                                    _jsx(Shield, { className: "h-3.5 w-3.5" }),
                                    "Usuario",
                                  ],
                                }),
                          }),
                          _jsx("td", {
                            ...
                            children: user.is_active
                              ? _jsxs(Badge, {
                                  className:
                                    "gap-1 bg-primary/10 text-primary hover:bg-primary/10 border-primary/20",
                                  children: [
                              ...
                              : _jsxs(Badge, {
                                  className:
                                    "gap-1 bg-muted text-muted-foreground hover:bg-muted border-border",
                                  children: [
                                    _jsx(UserIcon, {
                                      className: "h-3.5 w-3.5",
                                    }),
