  ...
  return _jsxs(PageContainer, {
    children: [
      _jsx(PageHeader, {
        title: "V\u00EDdeo",
        description:
          "Configura el v\u00EDdeo de fondo y el enlace de YouTube de la web.",
      }),
      _jsxs(Alert, {
        variant: "destructive",
        ...
        children: [
          ...
          _jsx(AlertTitle, { children: "V\u00EDdeo del hero" }),
          _jsxs(AlertDescription, {
            className: "text-sm",
            children: [
              "El v\u00EDdeo de fondo se muestra en el hero de la home. El enlace de YouTube es auxiliar y opcional. Usa el enlace de compartir de YouTube (Share), por ejemplo: ",
              _jsx("span", {
                className: "font-mono",
                children: "https://youtu.be/ID",
              }),
              ".",
            ],
          }),
                  ...
                  children: [
                    backgroundVideoUrl &&
                      _jsxs("div", {
                        className: "space-y-2",
                        children: [
                          _jsx(Label, { children: "Preview actual" }),
                          _jsx("video", {
                            ...
                            playsInline: true,
                            className:
                              "w-full rounded-md border border-border/60 bg-black",
                          }),
                        ],
                      }),
                    _jsxs("div", {
                      ...
                      children: [
                        _jsxs("label", {
                          ...
                          children: [
                            _jsx("span", {
                              children: "Activar v\u00EDdeo de fondo (hero)",
                            }),
                            _jsx(Switch, {
                        ...
                        _jsxs("div", {
                          className: "space-y-2",
                          children: [
                            _jsx(Label, { children: "T\u00EDtulo interno" }),
                            _jsx(Input, {
