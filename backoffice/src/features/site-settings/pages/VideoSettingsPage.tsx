...
export function VideoSettingsPage() {
  ...
  const handleChange = (
    field: keyof VideoFormState,
    value: VideoFormState[keyof VideoFormState],
  ) => {
            ...
            <Card className="border-l-4 border-l-primary shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Este vídeo se reproduce automáticamente en bucle en la
                  pantalla principal.
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                {!form.video_enabled && (
                  <Alert variant="default" className="bg-muted/50">
                    <AlertDescription>
                      El vídeo está desactivado. La portada mostrará la imagen
                      por defecto o un color sólido.
                    </AlertDescription>
                  </Alert>
                )}
                  ...
                  <div className="space-y-4">
                    ...
                    <Alert variant="destructive" className="py-3">
                      ...
                      <AlertDescription className="text-xs mt-1 space-y-1">
                        <p>
                          • Peso máximo recomendado: <strong>10 MB</strong>{" "}
                          (Ideal: &lt;5MB)
                        </p>
                        <p>
                          • <strong>Sin pista de audio</strong> (elimínala antes
                          de subir)
                        </p>
                ...
                <div className="grid md:grid-cols-[1fr_200px] gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Enlace opcional. Se usa habitualmente para un botón "Ver
                      vídeo completo" o un modal promocional.
                    </p>
                  </div>
                  {form.youtube_url && (
                    <div className="space-y-2">
