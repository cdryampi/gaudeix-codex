  ...
  return _jsxs(PageContainer, {
    children: [
      _jsx(PageHeader, {
        title: "Header",
        description:
          "Configura el men\u00FA principal del header (categor\u00EDas, p\u00E1ginas est\u00E1ticas o links).",
      ...
      _jsxs(Alert, {
        ...
        children: [
          ...
          _jsx(AlertTitle, { children: "Men\u00FA sensible" }),
                  ...
                  children: [
                    _jsx(TableHeader, {
                      children: _jsxs(TableRow, {
                        children: [
                          _jsx(TableHead, { children: "Etiqueta" }),
                          _jsx(TableHead, { children: "Tipo" }),
                          _jsx(TableHead, { children: "Padre" }),
                          _jsx(TableHead, { children: "Orden" }),
                          _jsx(TableHead, {
                    ...
                    _jsx(TableBody, {
                      children: filtered.map(({ item, depth }) => {
                                ...
                                children: _jsxs("div", {
                                  ...
                                  children: [
                                    depth > 0
                                      ...
                                      : null,
                                    _jsx("span", { children: displayLabel }),
                                  ],
                                }),
                              }),
                              _jsx(TableCell, { children: item.type }),
                              _jsx(TableCell, { children: parentLabel }),
                              _jsx(TableCell, { children: item.order }),
                              _jsx(TableCell, {
                                className: "text-right",
                                children: _jsxs("div", {
          ...
          children: [
            _jsx(DialogHeader, {
              children: _jsx(DialogTitle, {
                children: form.id ? "Editar ítem" : "Nuevo ítem",
              }),
            }),
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  className: "space-y-2",
                  children: [
                    _jsx(Label, { children: "Padre (opcional)" }),
                    _jsxs("select", {
                      value: form.parent ?? "",
                      onChange: (e) =>
                        handleChange(
                      ...
                      children: [
                        ...
                        parentsOptions.map((p) =>
                          _jsx(
                            ...
                            {
                              value: p.id,
                              children: `${"\u00A0".repeat(p.depth * 3)}${p.label}`,
                            },
                            p.id,
                          ),
                        ),
                ...
                form.type === "static_page" &&
                  _jsxs("div", {
                    className: "space-y-2 md:col-span-2",
                    children: [
                      _jsx(Label, { children: "P\u00E1gina est\u00E1tica" }),
                      _jsxs("select", {
