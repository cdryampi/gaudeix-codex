...
export const eventsApi = {
    ...
    getById: async (id) => {
        const response = await apiClient.get(API_ENDPOINTS.EVENTS.DETAIL(String(id)));
    ...
    update: async (id, data) => {
        ...
        const response = await apiClient.patch(API_ENDPOINTS.EVENTS.DETAIL(String(id)), payload);
        return normalizeEvent(response.data);
    },
    delete: async (id) => {
