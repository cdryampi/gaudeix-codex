...
import { Users, Calendar, MapPin, Bell, FileText, ArrowRight, Plus } from "lucide-react";
...
export function DashboardHome() {
  ...
  const QuickAction = ({ to, icon: Icon, title, desc, color, ringColor }: any) => (
    <Link 
      to={to} 
    ...
    >
      <div className={`mb-4 inline-flex h-14 w-14 items-center justify-center rounded-xl ${color} shadow-sm transition-transform group-hover:scale-110 group-hover:rotate-3`}>
    ...
    <div className="container flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center px-4 py-8 mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center space-x-3">
           ...
           <Link to={ROUTES.EVENTS} className="inline-flex items-center justify-center rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:bg-primary-600 dark:hover:bg-primary-700">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6">
           <div className="flex items-center justify-between">
             ...
             <Link to="#" className="text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400">Ver todo</Link>
           </div>
             ...
             {recentActivity.length === 0 ? (
                ...
                <div className="relative border-l border-gray-200 dark:border-gray-700 ml-3 space-y-6">
                  {recentActivity.map((activity, idx) => (
                    <div key={activity.id || idx} className="mb-6 ml-6 last:mb-0">
