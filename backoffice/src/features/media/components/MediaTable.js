...
export function MediaTable({ items, onDelete, onRename, linkedMap = {} }) {
  return _jsx("div", {
    className:
    ...
    children: _jsx(ScrollArea, {
      ...
      children: _jsxs("table", {
        className: "w-full min-w-[860px] table-auto caption-bottom text-sm",
        children: [
          _jsx("thead", {
            className:
            ...
            children: _jsxs("tr", {
              ...
              children: [
                _jsx("th", { children: "Archivo" }),
                _jsx("th", { children: "Tipo" }),
                _jsx("th", { children: "Vinculado" }),
                _jsx("th", { children: "Tama\u00F1o" }),
                _jsx("th", { children: "Creado" }),
                    ...
                    _jsxs(
                      "tr",
                      {
                        ...
                        children: [
                          ...
                          _jsx("td", {
                            className:
                              "px-5 py-4 align-middle text-muted-foreground",
                            children: formatSize(item.size_bytes),
                          }),
                          _jsx("td", {
                            className:
                              "px-5 py-4 align-middle text-muted-foreground",
...
function Thumb({ item }) {
  ...
  return _jsx("div", {
    className:
      "flex h-10 w-10 min-h-10 min-w-10 shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-600 ring-1 ring-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700",
    children: _jsx(FileText, { className: "h-5 w-5" }),
  });
}
function LinkedModelCell({ item, linkedMap }) {
  const key = `${item.type}-${item.id}`;
  const linked = linkedMap[key] || [];
  if (linked.length === 0) {
    return _jsx("span", {
      className: "text-muted-foreground",
      children: "Sin v\u00EDnculo",
    });
  }
  return _jsx("div", {
    className: "flex flex-col gap-1",
    children: linked.map((link, index) =>
      _jsxs(
        "div",
        {
