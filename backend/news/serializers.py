...
class NewsSerializer(TranslatableModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "slug", "image_url", "fecha_creacion", "fecha_modificacion"]
    ...
    def save(self, **kwargs):
        ...
        for field in ["title", "summary", "body"]:
            if field in self.initial_data and not self.initial_data.get("translations", {}).get(base_lang, {}).get(field):
                ...
                self.validated_data["translations"][base_lang][field] = self.initial_data[field]
