...
SEED_PIPELINE: list[tuple[str, str, str]] = [
    ...
    ("footer_settings", "seed_footer_settings", "Seeding footer settings..."),
    ("footer_links", "seed_footer_links", "Seeding footer links..."),
    ("footer_badges", "seed_footer_badges", "Seeding footer badges..."),
    ...
    ("beaches", "seed_beaches", "Seeding beaches..."),
    ("events_category", "seed_events_category", "Seeding events category..."),
    ("events", "seed_events", "Seeding events..."),
    ("routes_category", "seed_routes_category", "Seeding routes category..."),
    ("routes", "seed_routes", "Seeding routes..."),
    ...
    ("storytelling", "seed_storytelling", "Seeding storytelling..."),
